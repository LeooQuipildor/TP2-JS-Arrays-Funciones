# TP-2 JavaScript - Arrays y Funciones

![JavaScript img](https://soyhorizonte.com/wp-content/uploads/2020/10/Javascript-by-SoyHorizonte.jpg)

Este repositorio contiene ejercicios propuestos por rollingcode a modo de practica de arrays y funciones en javascript
...
```bash
git clone https://github.com/LeooQuipildor/TP2-JS-Arrays-Funciones
```
